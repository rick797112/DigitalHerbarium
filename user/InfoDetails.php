        <?php  
            ...
            echo '<h1 class="mt-5 mb-3 text-center"><a href="downloadfile.php?Slno='.$slno.'"><i style="font-size:30px;" class="fa fa-download" aria-hidden="true"><p style="font-size:15px; color: black; text-align: center;">Click Here To Download This Page</p></i></a></h1>';
            echo "<br>";
            ...
            echo"<div class='col-md-6 col-sm-12'>";
                ...
                // Fetch one and one row
                    while ($row = mysqli_fetch_assoc($result)){
                        echo "<img style='border-radius: 10px; margin: auto; width: 100%; height: 350px' alt='Flora' src=../Admin/".$row["img"].">";
                        echo "<br></div>";
